<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Lab2_LTWeb.Registration" %>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtName" ErrorMessage="Candidate Name can not be blank!" Display="None" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtAge" Display="Dynamic" ErrorMessage="Độ tuổi phải từ 18 đến 60" ForeColor="Red" MaximumValue="60" MinimumValue="18" Type="Integer"></asp:RangeValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style4">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDOB" Display="Dynamic" ErrorMessage="Năm sinh phải có dạng dd/mm/yy" ForeColor="Red" ValidationExpression="(0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])[- /.](19|20)\d\d"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3">Social Security Number</td>
                    <td class="auto-style4">
                        <asp:TextBox ID="txtSSN" runat="server" Width="175px" TextMode="Number"></asp:TextBox>
                        <span style="color:red;">*</span>
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:TextBox ID="txtPhone" runat="server" Width="175px" TextMode="Number"></asp:TextBox>
                    <span style="color:red;">*</span>
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:TextBox ID="txtMobile" runat="server" Width="177px" TextMode="Number"></asp:TextBox>
                    &nbsp;</td>
                </tr>
                <tr>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtEmailID" Display="Dynamic" ErrorMessage="Email phải đúng chuẩn!" ForeColor="Red" ValidationExpression="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style3">Zip Code</td>
                    <td class="auto-style4">
                       <asp:TextBox ID="txtZipCode" runat="server" Width="175px" TextMode="Number"></asp:TextBox>
                    <span style="color:red;">*</span>
